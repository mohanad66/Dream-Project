      ...
      <div className="analytics-content">
        ...
        {activeTab === "commission" && (<>
          <div className="analytics-stats-row" style={{ gridTemplateColumns: "repeat(3,1fr)" }}>
            ...
            <KPICard label="Platform Commission (30d)" value={fmtL(sellerEarnings.summary?.total_commission_30d)} sub="Commission earned" accent={TOKEN.warning} icon={<DollarSign size={18} color="var(--color-gold, #0ea5a4)" />} />

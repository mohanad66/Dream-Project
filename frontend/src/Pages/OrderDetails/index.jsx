...
export default function OrderDetailsPage() {
  ...
  const getTrackingSteps = () => {
    ...
    return steps.map((step, index) => ({
      ...step,
      isCompleted:
        order?.status === "cancelled" ? false : index <= currentStepIndex,
          ...
          {order.payment && (
            <div className="info-card">
              ...
              <p>
                ...
                {parseFloat(order.payment.amount).toFixed(1)} L.E
              </p>
              <p>
          ...
          <div className="tracking-section">
            ...
            <div className="tracking-timeline">
              {trackingSteps.map((step, index) => (
                <div
                  key={step.status}
                  className={`tracking-step ${step.isCompleted ? "completed" : ""} ${step.isCurrent ? "current" : ""}`}
                >
            ...
            {order.items?.map((item) => (
              <div key={item.id} className="order-item-detail">
                <div className="order-item-info">
                  ...
                  <p>
                    Unit Price: {parseFloat(item.unit_price).toFixed(1)} L.E
                  </p>
                </div>
